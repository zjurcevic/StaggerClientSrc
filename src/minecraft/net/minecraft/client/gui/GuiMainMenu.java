...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, j + 72 + 12, 94, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2 - 4, j + 72 + 12, 94, 20, I18n.format("menu.quit", new Object[0])));
    ...
    {
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, (p_73969_1_) - 20, 190, 20, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, (p_73969_1_ + p_73969_2_ * 1) - 20, 170, 20, I18n.format("menu.multiplayer", new Object[0])));
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, (p_73969_1_ + p_73969_2_ * 2) - 20, 160, 20, I18n.format("About", new Object[0])));
        this.buttonList.add(this.realmsButton = new GuiButton(14, this.width / 2 - 100, (p_73969_1_ + p_73969_2_ * 3) - 20, 175, 20, I18n.format("menu.online", new Object[0])));
        this.buttonList.add(new GuiButtonSurrey(21, this.width / 2 + 85, (p_73969_1_ + p_73969_2_ * 2) - 55, 95, 95, ""));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id == 3)
        {
            this.mc.displayGuiScreen(new StaggerGui(this));
        }
        ...
        if(button.id == 21)
        {
            try
            {
                Desktop.getDesktop().browse(new URI("https://www.surrey.ac.uk/"));
            }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.popMatrix();
        String s = "Stagger Client for Minecraft 1.8.8";
